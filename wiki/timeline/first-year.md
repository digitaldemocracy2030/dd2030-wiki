...
dd2030 Slackコミュニティが発足してから1年間に何が起こったかを月ごとに記述する。骨子は [[quarterly-summary]] と同じだが、こちらは **個別チャンネルレベルまで掘り下げた詳細版**。出典には外部アーカイブ `oss_weekly_reporter` の週ディレクトリ名を付ける。
