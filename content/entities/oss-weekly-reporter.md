...
dd2030 においては、これが**[[timeline/first-year|過去1年間のSlackログとGitHub活動データの一次アーカイブ]]**になっており、[[overview|dd2030 wiki]] 自体の基盤データ源として機能している。詳細な参照手順は [archive_index.md](/archive_index.md) を参照。
...
追跡対象に入っていなかったチャンネルの議論は、このアーカイブには残らない。これは dd2030 wiki の構築上の重要な制約となる（→ [[timeline/first-year|初年度まとめ]] 末尾「含まれていない可能性があるもの」セクション）。
...
- [[timeline/first-year|初年度まとめ]] — このアーカイブから構築した時系列まとめ
